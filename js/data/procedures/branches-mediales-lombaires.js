...
ECHO.register({
  ...
  contreIndications: [
    ...
    '**Hémostase** : ASRA-ESRA 2018 classe les gestes facettaires (bloc de branche médiale et radiofréquence, à tous les étages) parmi les procédures à **risque intermédiaire** — pas d\'arrêt systématique des antiagrégants, gestion au cas par cas des anticoagulants oraux, décision partagée avec le prescripteur. À distinguer du geste **à faible risque** qu\'est l\'infiltration sacro-iliaque et des gestes **à haut risque** (stimulation médullaire, pompe intrathécale).',
...
- **Le second trou** : la valeur prédictive du bloc **échoguidé** avant RF n\'a pas été mesurée séparément. Compte tenu des 11 % d\'erreurs de position, un bloc échoguidé négatif chez un patient obèse ne permet pas d\'exclure une origine facettaire.`,
  ...
  references: [
    ...
    { auteurs: 'Greher M, Kirchmair L, Enna B, et al.', titre: 'Ultrasound-guided lumbar facet nerve block: accuracy of a new technique confirmed by computed tomography', revue: 'Anesthesiology', annee: '2004', type: 'faisabilité', verif: false, note: '45 aiguilles sur 50 au point cible, les autres à moins de 5 mm ; succès simulé par contraste 94 %.' },
    ...
    { auteurs: 'Cohen SP, Doshi TL, Constantinescu OC, et al.', titre: 'Medial branch blocks or intra-articular injections as a prognostic tool before lumbar facet radiofrequency denervation: a multicenter, case-control study', revue: 'Reg Anesth Pain Med', annee: '2015', type: 'étude comparative', verif: false, note: 'Compare la valeur prédictive du bloc de branche et de l\'infiltration intra-articulaire avant thermolésion.' },
  ...
  scenes: [
    {
      ...
      build: S => {
        ...
        S.muscle({ path: 'M0 300 L450 300 L450 412 L0 412 Z', label: 'Psoas\n(fenêtre inter-transversaire)', at: [293, 372], opacity: 0.4, small: true });
    ...
    },
    {
      ...
      build: S => {
        ...
        S.spread({ x: 366, y: 318, rx: 34, ry: 8, label: '0,5 mL' });
      },
    },
  ],
