...
- **Trous de la littérature, à assumer** : pas d\'ECR de bonne qualité comparant les techniques de ponction des kystes ; pas de donnée robuste sur l\'infiltration de l\'arthrose radio-carpienne isolée ; l\'intérêt de l\'immobilisation après ponction d\'un kyste repose sur l\'usage, pas sur la preuve. Enfin, aucune donnée ne soutient l\'infiltration intra-articulaire dans le **SDRC** — l\'absence de preuve est ici doublée d\'une absence de rationnel.`,
    ...
    references: [
      { auteurs: 'Sibbitt WL Jr, Peisajovich A, Michael AA, et al.', titre: 'Does sonographic needle guidance affect the clinical outcome of intraarticular injections?', revue: 'J Rheumatol', annee: '2009', pmid: '19648304', type: 'ECR', verif: true, note: 'Guidage échographique vs repérage anatomique : précision et résultat clinique.' },
      { auteurs: 'Dias JJ, Buch K', titre: 'Palmar wrist ganglion: does intervention improve outcome? A prospective study of the natural history and patient-reported treatment outcomes', revue: 'J Hand Surg Br', annee: '2003', doi: '10.1016/S0266-7681(02)00365-0', pmid: '12631492', type: 'cohorte', verif: true, note: 'Histoire naturelle des kystes palmaires et intérêt discuté de l\'intervention.' },
      { auteurs: 'Dias JJ, Dhukaram V, Kumar P', titre: 'The natural history of untreated dorsal wrist ganglia and patient reported outcome 6 years after intervention', revue: 'J Hand Surg Eur Vol', annee: '2007', doi: '10.1016/j.jhse.2007.05.007', type: 'cohorte', verif: true, note: 'Suivi à 6 ans des kystes dorsaux traités et non traités.' },
      ...
      { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage)', annee: '2007', doi: '10.1007/978-3-540-28163-4', type: 'ouvrage', verif: true, note: 'Sono-anatomie du poignet dorsal, compartiments extenseurs, kystes et pédicule.' },
      ...
      { auteurs: 'Backhaus M, Burmester GR, Gerber T, et al.', titre: 'Guidelines for musculoskeletal ultrasound in rheumatology', revue: 'Ann Rheum Dis', annee: '2001', doi: '10.1136/ard.60.7.641', pmid: '11406516', type: 'reco', verif: true, note: 'Coupes standard et définitions (épanchement, synovite).' },
