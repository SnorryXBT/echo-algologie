...
*Fiche rédigée sans accès à la recherche en ligne : le fond technique et posologique correspond aux pratiques établies, mais les chiffres sont donnés en fourchettes et les métadonnées des références n\'ont pas pu être revérifiées dans cette session. Les entrées marquées « à vérifier » sont à confirmer avant citation.*`,
  ...
  references: [
    { auteurs: 'Hashiuchi T, Sakurai G, Morimoto M, Komei T, Takakura Y, Tanaka Y', titre: 'Accuracy of the biceps tendon sheath injection: ultrasound-guided or unguided injection? A randomized controlled trial', revue: 'J Shoulder Elbow Surg', annee: '2011;20(7):1069-73', pmid: '21782470', type: 'ECR', verif: true, note: 'Essai de référence sur la précision comparée guidée / non guidée.' },
    { auteurs: 'Gazzillo GP, Finnoff JT, Hall MM, Sayeed YA, Smith J', titre: 'Accuracy of palpating the long head of the biceps tendon: an ultrasonographic study', revue: 'PM R', annee: '2011;3:1035-40', doi: '10.1016/j.pmrj.2011.02.022', type: 'étude diagnostique', verif: true, note: 'La palpation de la gouttière est peu fiable — argument pour le guidage.' },
    { auteurs: 'Habermeyer P, Magosch P, Pritsch M, Scheibel MT, Lichtenberg S', titre: 'Anterosuperior impingement of the shoulder as a result of pulley lesions: a prospective arthroscopic study', revue: 'J Shoulder Elbow Surg', annee: '2004;13(1):5-12', pmid: '14735066', type: 'étude prospective', verif: true, note: 'Lésions de poulie, instabilité du long biceps et atteinte associée du subscapulaire.' },
    { auteurs: 'Beggs I, Bianchi S, Bueno A, et al.', titre: 'Musculoskeletal ultrasound technical guidelines — shoulder', revue: 'European Society of Musculoskeletal Radiology (ESSR)', annee: '2010', url: 'https://essr.org/content-essr/uploads/2016/10/shoulder.pdf', type: 'reco', verif: true, note: 'Coupes standardisées, dont la coupe transversale de la gouttière bicipitale.' },
    { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage de référence)', annee: '2007', doi: '10.1007/978-3-540-28163-4', type: 'ouvrage', verif: true, note: 'Sono-anatomie de la gouttière, de la gaine et des variantes (luxation médiale).' },
    { auteurs: 'Jacobson JA', titre: 'Fundamentals of Musculoskeletal Ultrasound', revue: 'Elsevier (ouvrage de référence)', annee: '2017 (3e éd.)', url: 'https://shop.elsevier.com/books/fundamentals-of-musculoskeletal-ultrasound/jacobson/978-0-323-44525-2', type: 'ouvrage', verif: true, note: 'Description des voies d\'abord de la gaine du long biceps et des pièges d\'anisotropie.' },
