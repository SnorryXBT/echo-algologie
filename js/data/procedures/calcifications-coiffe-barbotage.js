...
*Fiche rédigée sans accès à la recherche en ligne : le fond technique et posologique correspond aux protocoles publiés, mais les chiffres sont donnés en fourchettes et les métadonnées des références n\'ont pas pu être revérifiées dans cette session. Les entrées marquées « à vérifier » sont à confirmer avant citation.*`,
  ...
  references: [
    { auteurs: 'de Witte PB, Selten JW, Navas A, et al.', titre: 'Calcific tendinitis of the rotator cuff: a randomized controlled trial of ultrasound-guided needling and lavage versus subacromial corticosteroids', revue: 'Am J Sports Med', annee: '2013;41:1665-73', doi: '10.1177/0363546513487066', type: 'ECR', verif: true, note: 'Essai de référence : supériorité du barbotage sur l\'infiltration seule à un an.' },
    { auteurs: 'Serafini G, Sconfienza LM, Lacelli F, Silvestri E, Aliprandi A, Sardanelli F', titre: 'Rotator cuff calcific tendonitis: short-term and 10-year outcomes after two-needle US-guided percutaneous treatment — nonrandomized controlled trial', revue: 'Radiology', annee: '2009;252(1):157-64', doi: '10.1148/radiol.2521081816', type: 'étude contrôlée non randomisée', verif: true, note: 'Technique à deux aiguilles, recul à 10 ans.' },
    { auteurs: 'Sconfienza LM, Bandirali M, Serafini G, et al.', titre: 'Rotator cuff calcific tendinitis: does warm saline solution improve the short-term outcome of double-needle US-guided treatment?', revue: 'Radiology', annee: '2012;262:560-6', doi: '10.1148/radiol.11111157', type: 'ECR', verif: true, note: 'Base du tiédissement du liquide de lavage à 37 °C.' },
    { auteurs: 'Lanza E, Banfi G, Serafini G, et al.', titre: 'Ultrasound-guided percutaneous irrigation in rotator cuff calcific tendinopathy: what is the evidence? A systematic review with proposals for future reporting', revue: 'Eur Radiol', annee: '2015;25(7):2176-83', doi: '10.1007/s00330-014-3567-1', type: 'revue systématique', verif: true, note: 'Documente l\'hétérogénéité technique majeure de la littérature.' },
    { auteurs: 'Louwerens JKG, Sierevelt IN, Kramer ET, et al.', titre: 'Comparing ultrasound-guided needling combined with a subacromial corticosteroid injection versus high-energy extracorporeal shockwave therapy for calcific tendinitis of the rotator cuff: a randomized controlled trial', revue: 'Arthroscopy', annee: '2020;36:1823-33.e1', doi: '10.1016/j.arthro.2020.02.027', type: 'ECR', verif: true, note: 'Comparaison directe barbotage vs ondes de choc.' },
    { auteurs: 'Molé D, Kempf JF, Gleyze P, Rio B, Bonnomet F, Walch G', titre: 'Résultats du traitement arthroscopique des tendinopathies non rompues de la coiffe des rotateurs — 2. Calcifications de la coiffe des rotateurs', revue: 'Rev Chir Orthop Reparatrice Appar Mot', annee: '1993;79:532-41', type: 'série', verif: true, note: 'Origine de la classification A / B / C / D utilisée en France.' },
    { auteurs: 'Gärtner J, Heyer A', titre: 'Calcific tendinitis of the shoulder', revue: 'Orthopade', annee: '1995;24(3):284-302', pmid: '7617385', type: 'revue', verif: true, note: 'Classification radiologique I / II / III.' },
    { auteurs: 'Uhthoff HK, Loehr JW', titre: 'Calcific tendinopathy of the rotator cuff: pathogenesis, diagnosis, and management', revue: 'J Am Acad Orthop Surg', annee: '1997;5(4):183-91', doi: '10.5435/00124635-199707000-00001', type: 'revue', verif: true, note: 'Description des phases (formation, repos, résorption) qui fonde le raisonnement sur le timing.' },
