...
| Infiltration thérapeutique | Corticoïde retard + AL : méthylprednisolone 40–80 mg (Dépo-Médrol®), ou triamcinolone acétonide 40 mg (Kenacort retard®), ou bétaméthasone : Diprostène® 1 mL (≈ 7 mg) ou Célestène® chronodose 1 mL (5,7 mg) + lidocaïne 1 % ou ropivacaïne 0,2 % | 4–6 mL | Le corticoïde **particulaire est ici légitime** : articulation profonde, pas d’artère terminale sur le trajet. C’est le schéma de référence |
| Ce qu’on **n’utilise pas** à la hanche | Triamcinolone hexacétonide (Hexatrione® 2 %) | — | L’ANSM a restreint l’usage d’Hexatrione® après des signalements de **coxarthrose destructrice rapide** survenues après infiltration intra-articulaire de hanche : ce produit est réservé aux autres articulations, le genou en particulier. *Restriction à revérifier sur le RCP et les communications ANSM en vigueur avant tout emploi.* |
...
- **Trou de la littérature** : il n’existe pas d’étude de bon niveau évaluant la valeur **prédictive** du bloc test intra-articulaire de hanche pour le résultat d’une arthroplastie. La pratique repose sur des séries et sur le raisonnement clinique. *À confirmer lors de la passe de vérification bibliographique.*`,
  ...
  references: [
    { auteurs: 'Lambert RGW, et al.', titre: 'Steroid injection for osteoarthritis of the hip: a randomized, double-blind, placebo-controlled trial', revue: 'Arthritis Rheum', annee: '2007', doi: '10.1002/art.22739', pmid: '17599747', type: 'ECR', verif: true, note: 'ECR de référence pour le corticoïde intra-articulaire de hanche (guidage fluoroscopique).' },
    { auteurs: 'Atchia I, et al.', titre: 'Efficacy of a single ultrasound-guided injection for the treatment of hip osteoarthritis', revue: 'Ann Rheum Dis', annee: '2011', pmid: '21068096', type: 'ECR', verif: true, note: 'Essai à quatre bras (corticoïde, acide hyaluronique, sérum, soins usuels) sous guidage échographique.' },
    { auteurs: 'Kompel AJ, Roemer FW, Murakami AM, Diaz LE, Crema MD, Guermazi A', titre: 'Intra-articular corticosteroid injections in the hip and knee: perhaps not as safe as we thought?', revue: 'Radiology', annee: '2019', doi: '10.1148/radiol.2019190341', type: 'revue / mise en garde', verif: true, note: 'Description des quatre événements indésirables articulaires imputés aux infiltrations de corticoïde.' },
    { auteurs: 'Bannuru RR, Osani MC, Vaysbrot EE, et al.', titre: 'OARSI guidelines for the non-surgical management of knee, hip, and polyarticular osteoarthritis', revue: 'Osteoarthritis Cartilage', annee: '2019', doi: '10.1016/j.joca.2019.06.011', pmid: '31278997', type: 'recommandation', verif: true, note: 'Corticoïde intra-articulaire en recommandation conditionnelle à la hanche, sous guidage par l’image.' },
    ...
    { auteurs: 'Pfirrmann CWA, Chung CB, Theumann NH, Trudell DJ, Resnick D', titre: 'Greater trochanter of the hip: attachment of the abductor mechanism and a complex of three bursae — MR imaging and MR bursography in cadavers and MR imaging in asymptomatic volunteers', revue: 'Radiology', annee: '2001', doi: '10.1148/radiol.2211001634', pmid: '11687692', type: 'anatomie', verif: true, note: 'Cité ici pour l’anatomie régionale de la hanche ; référence principale de la fiche GTPS.' },
    { auteurs: 'Micu MC, Bogdan GD, Fodor D', titre: 'Steroid injection for hip osteoarthritis: efficacy under ultrasound guidance', revue: 'Rheumatology (Oxford)', annee: '2010', url: 'https://academic.oup.com/rheumatology/article-abstract/49/8/1490/1789306', type: 'série prospective', verif: true, note: 'Série prospective de 40 hanches avec synovite échographique ; effet jusqu\'à 3 mois.' },
