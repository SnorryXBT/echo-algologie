...
- **Trous assumés** : aucun essai n'a comparé fenestration, PRP et dextrose entre eux avec une puissance suffisante ; et il n'existe pas de donnée permettant de dire si l'infiltration anserine ajoute quoi que ce soit au traitement de la gonarthrose médiale sous-jacente. Ces deux questions sont exactement celles que pose la pratique — la littérature n'y répond pas.`,
  ...
  references: [
    { auteurs: `Kongsgaard M, Kovanen V, Aagaard P, et al.`, titre: `Corticosteroid injections, eccentric decline squat training and heavy slow resistance training in patellar tendinopathy`, revue: `Scandinavian Journal of Medicine & Science in Sports`, annee: '2009', doi: '10.1111/j.1600-0838.2009.00949.x', type: 'ECR', verif: true, note: `Corticoïde bon à court terme, charge supérieure à long terme.` },
    { auteurs: `Coombes BK, Bisset L, Vicenzino B`, titre: `Efficacy and safety of corticosteroid injections and other injections for management of tendinopathy: a systematic review of randomised controlled trials`, revue: `The Lancet`, annee: '2010', pmid: '20970844', type: 'revue systématique', verif: true },
    { auteurs: `Dragoo JL, Wasterlain AS, Braun HJ, Nead KT`, titre: `Platelet-rich plasma as a treatment for patellar tendinopathy: a double-blind, randomized controlled trial`, revue: `The American Journal of Sports Medicine`, annee: '2014', doi: '10.1177/0363546513518416', type: 'ECR', verif: true },
    { auteurs: `Scott A, LaPrade RF, Harmon KG, et al.`, titre: `Platelet-rich plasma for patellar tendinopathy: a randomized controlled trial of leukocyte-rich PRP or leukocyte-poor PRP versus saline`, revue: `The American Journal of Sports Medicine`, annee: '2019', doi: '10.1177/0363546519837954', type: 'ECR', verif: true, note: `Essai négatif : aucune supériorité du PRP sur le sérum.` },
    { auteurs: `Malliaras P, Barton CJ, Reeves ND, Langberg H`, titre: `Achilles and patellar tendinopathy loading programmes: a systematic review comparing clinical outcomes and identifying potential mechanisms for effectiveness`, revue: `Sports Medicine`, annee: '2013', doi: '10.1007/s40279-013-0019-z', type: 'revue systématique', verif: true },
    { auteurs: `Rudavsky A, Cook J`, titre: `Physiotherapy management of patellar tendinopathy (jumper's knee)`, revue: `Journal of Physiotherapy`, annee: '2014', doi: '10.1016/j.jphys.2014.06.022', type: 'revue', verif: true },
    { auteurs: `Ryan M, Wong A, Rabago D, Lee K, Taunton J`, titre: `Ultrasound-guided injections of hyperosmolar dextrose for overuse patellar tendinopathy: a pilot study`, revue: `British Journal of Sports Medicine`, annee: '2011', doi: '10.1136/bjsm.2010.081455', type: 'pilote', verif: true },
    { auteurs: `Housner JA, Jacobson JA, Misko R`, titre: `Sonographically guided percutaneous needle tenotomy for the treatment of chronic tendinosis`, revue: `Journal of Ultrasound in Medicine`, annee: '2009', doi: '10.7863/jum.2009.28.9.1187', type: 'série', verif: true },
    { auteurs: `Finnoff JT, Fowler SP, Lai JK, et al.`, titre: `Treatment of chronic tendinopathy with ultrasound-guided needle tenotomy and platelet-rich plasma injection`, revue: `PM&R`, annee: '2011', doi: '10.1016/j.pmrj.2011.05.015', type: 'série', verif: true },
    { auteurs: `Finnoff JT, Nutz DJ, Henning PT, et al.`, titre: `Accuracy of ultrasound-guided versus unguided pes anserinus bursa injections`, revue: `PM&R`, annee: '2010', doi: '10.1016/j.pmrj.2010.03.014', type: 'cadavérique', verif: true },
    { auteurs: `Yoon HS, Kim SE, Suh YR, Seo YI, Kim HA`, titre: `Correlation between ultrasonographic findings and the response to corticosteroid injection in pes anserinus tendinobursitis syndrome in knee osteoarthritis patients`, revue: `Journal of Korean Medical Science`, annee: '2005', pmid: '15716614', type: 'série', verif: true },
