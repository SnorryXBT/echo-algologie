...
- **Ce que la littérature ne dit pas** : pas de consensus sur le nombre de blocs d\'une série, pas de comparaison directe C6 vs C7 sur des critères cliniques durs, pas de donnée robuste au-delà de 6 mois, et une définition du succès (Horner vs Δ température vs imagerie de perfusion) qui varie d\'une étude à l\'autre — ce qui explique une bonne part de l\'hétérogénéité des méta-analyses.`,
  ...
  references: [
    { auteurs: 'Kapral S, Krafft P, Gosch M, Fleischmann D, Weinstabl C', titre: 'Ultrasound imaging for stellate ganglion block: direct visualization of puncture site and local anesthetic spread', revue: 'Reg Anesth', annee: '1995', type: 'technique', note: 'Première description échoguidée ; 5 mL échoguidés vs 8 mL à l\'aveugle.' },
    { auteurs: 'Narouze S, Vydyanathan A, Patel N', titre: 'Ultrasound-guided stellate ganglion block successfully prevented esophageal puncture', revue: 'Pain Physician', annee: '2007;10(6):747-52', pmid: '17987096', type: 'cas clinique' },
    { auteurs: 'Narouze S', titre: 'Ultrasound-guided stellate ganglion block: safety and efficacy', revue: 'Curr Pain Headache Rep', annee: '2014;18(6):424', doi: '10.1007/s11916-014-0424-5', type: 'revue', note: 'Le plan cible : en avant-dehors du long du cou, sous le fascia prévertébral, au-dessus du fascia propre du muscle.' },
    { auteurs: 'Bhatia A, Flamer D, Peng PW', titre: 'Evaluation of sonoanatomy relevant to performing stellate ganglion blocks using anterior and lateral simulated approaches: an observational study', revue: 'Can J Anaesth', annee: '2012', type: 'anatomie', note: '100 patients ; œsophage latéral à la trachée dans 50 % des cas à C6 et 74 % à C7.' },
    { titre: 'Do not follow the bone, follow the nerve — ultrasound-guided stellate ganglion block: a reconfirmation', revue: 'Reg Anesth Pain Med (correspondance)', annee: '2019', pmid: '31656628', type: 'technique' },
    { titre: 'Efficacy of stellate ganglion interventions for complex regional pain syndrome in the upper limb — a systematic review and meta-analysis', revue: 'Indian J Anaesth', annee: '2023;67(8)', pmid: '37693027', type: 'méta-analyse' },
    { titre: 'CT-guided stellate ganglion pulsed radiofrequency stimulation for facial and upper limb postherpetic neuralgia', revue: 'Front Neurosci', annee: '2019;13:170', doi: '10.3389/fnins.2019.00170', type: 'étude comparative' },
    { titre: 'Ultrasound-guided pulsed radiofrequency treatment of the cervical sympathetic chain for complex regional pain syndrome: a retrospective observational study', annee: '2017', pmid: '28072749', type: 'série rétrospective', note: 'Auteurs et revue non confirmés dans la recherche — vérifier sur PubMed avant citation.' },
    { titre: 'Tonic–clonic seizure during the ultrasound-guided stellate ganglion block because of an injection into an unrecognized variant vertebral artery: a case report', annee: '2019', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6890314/', type: 'cas clinique', note: 'Le cas de référence pour la convulsion immédiate sur variante vasculaire.' },
    { titre: 'Atypical course of vertebral artery identified by ultrasound prescan before performing a stellate ganglion block', annee: '2022', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC9272721/', type: 'cas clinique', note: 'Justifie le balayage Doppler préalable systématique.' },
    { titre: 'Effects of stellate ganglion block on perimenopausal hot flashes: a randomized controlled trial', annee: '2023', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10715304/', type: 'ECR', note: '40 femmes, 6 blocs vs sérum salé, suivi 12 semaines.' },
    { titre: 'Stellate ganglion blockade for the treatment of post-traumatic stress disorder: a systematic review and meta-analysis', revue: 'Auton Neurosci', annee: '2025', pmid: '41151498', type: 'méta-analyse', note: '394 références criblées, 2 ECR + 1 cas-témoin retenus.' },
    { titre: 'Effects of stellate ganglion block through different approaches under guidance of ultrasound', revue: 'Front Surg', annee: '2021;8:797793', doi: '10.3389/fsurg.2021.797793', type: 'étude comparative' },
    { auteurs: 'Narouze S, Benzon HT, Provenzano D, et al.', titre: 'Interventional spine and pain procedures in patients on antiplatelet and anticoagulant medications (second edition): guidelines from the ASRA, ESRA, AAPM, INS, NANS and WIP', revue: 'Reg Anesth Pain Med', annee: '2018;43(3):225-62', doi: '10.1097/AAP.0000000000000700', type: 'reco', note: 'Bloc stellaire = risque hémorragique intermédiaire.' },
    { titre: 'Stellate ganglion blocks — StatPearls', revue: 'NCBI Bookshelf', annee: '2024', url: 'https://www.ncbi.nlm.nih.gov/books/NBK507798/', type: 'revue' },
  ],
  videos: [
  ...
  scenes: [
    {
      ...
      build: S => {
        ...
        S.label({ x: 428, y: 292, text: 'Tubercule ant. (Chassaignac)', anchor: 'middle', cls: 'lbl-bone', small: true, lead: [428, 302] });
        ...
        S.label({ x: 296, y: 208, text: 'Chaîne sympathique', anchor: 'middle', cls: 'lbl-nerve', small: true, lead: [296, 240] });
      },
    },
    {
    ...
    },
    {
      ...
      build: S => {
        ...
        S.bone({ path: 'M190 350 Q270 338 350 334 L432 330 Q480 330 512 316 Q548 302 574 314', label: 'Processus transverse C7 — pas de tubercule antérieur', at: [300, 384], ldy: 0, small: true });
        S.artery({ x: 452, y: 306, r: 12, label: 'A. vertébrale (antérieure au transverse)', lx: 470, ly: 274, anchor: 'start', small: true, lead: [458, 300] });
        S.nerve({ x: 520, y: 344, r: 10, label: 'Racine C7', lx: 570, ly: 358, anchor: 'start', small: true, lead: [529, 346] });
