...
- **Artère vertébrale (segment V3)** : elle chemine dans le triangle sous-occipital, **en profondeur et en dehors de l\'OCI**, au-dessus de l\'arc postérieur de C1. Elle n\'est pas sur le trajet d\'une aiguille qui reste au contact dorsal de l\'OCI, mais elle est la raison pour laquelle on ne traverse jamais l\'OCI et on ne remonte jamais l\'aiguille en direction céphalique et latérale.
...
- **Doppler couleur systématique**, PRF basse et échelle de vitesse basse (5–10 cm/s) : artère occipitale en distal, artères musculaires et rameaux de l\'artère cervicale profonde en proximal.
...
| Bloc thérapeutique — névralgie occipitale, céphalée cervicogénique | Ropivacaïne 0,2–0,5 % ou lidocaïne 2 % + **dexaméthasone 4 mg** (non particulaire) ou bétaméthasone 3,75–5,7 mg | 3–5 mL proximal · 2–3 mL distal | Site à voisinage artériel : **corticoïde non particulaire à privilégier**, jamais de triamcinolone hexacétonide (Hexatrione®, strictement intra-articulaire) |
...
| Algie vasculaire — traitement transitionnel | Corticoïde retard sous-occipital (bétaméthasone forme mixte rapide + retard) ± AL | 2–3 mL, du côté des crises | Schéma des ECR contre placebo (Ambrosini 2005 ; Lancet Neurology 2011). Injection unique, en attendant l\'efficacité du vérapamil. Ne pas répéter à intervalles rapprochés |
  ...
  scenes: [
    {
      ...
      build: S => {
        ...
        S.label({ x: 300, y: 214, text: 'Plan interfascial = cible', cls: 'lbl-target', small: true });
      },
    },
    {
      ...
      build: S => {
        ...
        S.needle({ from: [640, 88], to: [330, 236], label: '22 G 50–80 mm, 25–35°' });
        S.spread({ x: 292, y: 240, rx: 76, ry: 13, label: '3–5 mL' });
      },
    },
    {
