...
- **Trous de la littérature, à assumer** : pas d\'essai de bonne qualité comparant infiltration échoguidée et infiltration à l\'aveugle **sur le résultat clinique** dans cette localisation ; pas de donnée sur le nombre optimal d\'injections ; pas d\'essai comparant l\'infiltration au traitement conservateur bien conduit.`,
    ...
    references: [
      { auteurs: 'Meenagh GK, Patton J, Kynes C, Wright GD', titre: 'A randomised controlled trial of intra-articular corticosteroid injection of the carpometacarpal joint of the thumb in osteoarthritis', revue: 'Ann Rheum Dis', annee: '2004', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC1754748/', type: 'ECR', verif: true, note: 'Essai négatif.' },
      { auteurs: 'Heyworth BE, Lee JH, Kim PD, et al.', titre: 'Hylan versus corticosteroid versus placebo for treatment of basal joint arthritis: a prospective, randomized, double-blinded clinical trial', revue: 'J Hand Surg Am', annee: '2008', pmid: '18261664', type: 'ECR', verif: true, note: 'Comparaison à trois bras.' },
      { auteurs: 'Kloppenburg M, Kroon FPB, Blanco FJ, et al.', titre: '2018 update of the EULAR recommendations for the management of hand osteoarthritis', revue: 'Ann Rheum Dis', annee: '2019', doi: '10.1136/annrheumdis-2018-213826', type: 'reco', verif: true, note: 'Orthèses, exercice et topiques en première ligne.' },
      { auteurs: 'Wajon A, Vinycomb T, Carr E, Edmunds I, Ada L', titre: 'Surgery for thumb (trapeziometacarpal joint) osteoarthritis', revue: 'Cochrane Database Syst Rev', annee: '2015', doi: '10.1002/14651858.CD004631.pub4', pmid: '25702783', type: 'revue systématique', verif: true, note: 'Version 2015 (pub4) ; signalée comme retirée (WITHDRAWN) en 2017 sur PubMed.' },
      { auteurs: 'Uson J, Rodriguez-García SC, Castellanos-Moreira R, et al.', titre: 'EULAR recommendations for intra-articular therapies', revue: 'Ann Rheum Dis', annee: '2021', doi: '10.1136/annrheumdis-2021-220266', pmid: '34035002', type: 'reco', verif: true },
      { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage)', annee: '2007', doi: '10.1007/978-3-540-28163-4', type: 'ouvrage', verif: true, note: 'Sono-anatomie de la colonne du pouce, tabatière anatomique, TMC et STT.' },
