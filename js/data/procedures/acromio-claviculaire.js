...
*Fiche rédigée sans accès à la recherche en ligne : le fond technique et posologique correspond aux pratiques établies, mais les chiffres cités le sont en fourchettes et les métadonnées des références n\'ont pas pu être revérifiées dans cette session. Les entrées marquées « à vérifier » sont à confirmer avant citation.*`,
  ...
  references: [
    { auteurs: 'Peck E, Lai JK, Pawlina W, Smith J', titre: 'Accuracy of ultrasound-guided versus palpation-guided acromioclavicular joint injections: a cadaveric study', revue: 'PM R', annee: '2010', type: 'étude cadavérique', verif: false, note: 'Étude de référence sur la précision comparée des deux techniques.' },
    { auteurs: 'Stein BE, Wiater JM, Pfaff HC, Bigliani LU, Levine WN', titre: 'Detection of acromioclavicular joint pathology in asymptomatic shoulders with magnetic resonance imaging', revue: 'J Shoulder Elbow Surg', annee: '2001', type: 'étude d\'imagerie', verif: false, note: 'Fondement de la règle « ne pas infiltrer sur l\'imagerie seule ».' },
    { auteurs: 'Chronopoulos E, Kim TK, Park HB, Ashenbrenner D, McFarland EG', titre: 'Diagnostic value of physical tests for isolated chronic acromioclavicular lesions', revue: 'Am J Sports Med', annee: '2004', type: 'étude diagnostique', verif: false, note: 'Valeur du test d\'adduction horizontale et des tests cliniques AC.' },
    { auteurs: 'Mall NA, Foley E, Chalmers PN, Cole BJ, Romeo AA, Bach BR', titre: 'Degenerative joint disease of the acromioclavicular joint: a review', revue: 'Am J Sports Med', annee: '2013', type: 'revue', verif: false, note: 'Revue générale : histoire naturelle, place des infiltrations et de la résection distale.' },
    { auteurs: 'Craig EV', titre: 'The geyser sign and torn rotator cuff: clinical significance and pathomechanics', revue: 'Clin Orthop Relat Res', annee: '1984', type: 'série / description', verif: false, note: 'Description princeps du signe du geyser.' },
    { auteurs: 'Beggs I, Bianchi S, Bueno A, et al.', titre: 'Musculoskeletal ultrasound technical guidelines — shoulder', revue: 'European Society of Musculoskeletal Radiology (ESSR)', annee: '2010', type: 'reco', verif: false, note: 'Coupes standardisées de l\'épaule, dont l\'incidence acromio-claviculaire.' },
    { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage de référence)', annee: '2007', type: 'ouvrage', verif: false, note: 'Sono-anatomie détaillée de l\'AC et de ses variantes.' },
