...
*Fiche rédigée sans accès à la recherche en ligne : le fond technique et posologique correspond aux pratiques établies, mais les chiffres sont donnés en fourchettes et les métadonnées des références n\'ont pas pu être revérifiées dans cette session. Les entrées marquées « à vérifier » sont à confirmer avant citation.*`,
  ...
  references: [
    { auteurs: 'Coombes BK, Bisset L, Brooks P, Khan A, Vicenzino B', titre: 'Effect of corticosteroid injection, physiotherapy, or both on clinical outcomes in patients with unilateral lateral epicondylalgia: a randomized controlled trial', revue: 'JAMA', annee: '2013', type: 'ECR', verif: false, note: 'Essai déterminant : moins bonne guérison complète et plus de rechutes à un an dans les bras corticoïde.' },
    { auteurs: 'Coombes BK, Bisset L, Vicenzino B', titre: 'Efficacy and safety of corticosteroid injections and other injections for management of tendinopathy: a systematic review and meta-analysis of randomised controlled trials', revue: 'Lancet', annee: '2010', type: 'méta-analyse', verif: false, note: 'Profil temporel du corticoïde dans les tendinopathies : bénéfice court terme, préjudice à distance.' },
    { auteurs: 'Bisset L, Beller E, Jull G, Brooks P, Darnell R, Vicenzino B', titre: 'Mobilisation with movement and exercise, corticosteroid injection, or wait and see for tennis elbow: randomised trial', revue: 'BMJ', annee: '2006', type: 'ECR', verif: false, note: 'Corticoïde supérieur à 6 semaines, inférieur à 52 semaines par rapport à l\'abstention surveillée.' },
    { auteurs: 'Mishra AK, Skrepnik NV, Edwards SG, et al.', titre: 'Efficacy of platelet-rich plasma for chronic tennis elbow: a double-blind, prospective, multicenter, randomized controlled trial of 230 patients', revue: 'Am J Sports Med', annee: '2014', type: 'ECR', verif: false, note: 'Essai favorable au PRP contre injection témoin à 24 semaines.' },
    { auteurs: 'Krogh TP, Fredberg U, Stengaard-Pedersen K, Christensen R, Jensen P, Ellingsen T', titre: 'Treatment of lateral epicondylitis with platelet-rich plasma, glucocorticoid, or saline: a randomized, double-blind, prospective study', revue: 'Am J Sports Med', annee: '2013', type: 'ECR', verif: false, note: 'Pas de supériorité du PRP sur le sérum salé : la contradiction à connaître avant de proposer un PRP payant.' },
    { auteurs: 'McShane JM, Nazarian LN, Harwood MI', titre: 'Sonographically guided percutaneous needle tenotomy for treatment of common extensor tendinosis in the elbow', revue: 'J Ultrasound Med', annee: '2006', type: 'série prospective', verif: false, note: 'Travail princeps de la fenestration échoguidée sur le tendon commun.' },
    { auteurs: 'Placzek R, Drescher W, Deuretzbacher G, Hempfing A, Meiss AL', titre: 'Treatment of chronic radial epicondylitis with botulinum toxin A: a double-blind, placebo-controlled, randomized multicenter study', revue: 'J Bone Joint Surg Am', annee: '2007', type: 'ECR', verif: false, note: 'Bénéfice modeste, parésie d\'extension des doigts constante.' },
    { auteurs: 'Spinner M', titre: 'The arcade of Frohse and its relationship to posterior interosseous nerve paralysis', revue: 'J Bone Joint Surg Br', annee: '1968', type: 'anatomie', verif: false, note: 'Description anatomique princeps de l\'arcade de Frohse.' },
