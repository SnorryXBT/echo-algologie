...
- **Ce que la littérature ne dit pas** : aucune étude ne compare le bloc du saphène aux blocs géniculés, ni ne quantifie l'apport de leur association dans la gonarthrose médiale — alors que c'est exactement la question posée en HDJ douleur. Le raisonnement anatomique (Tran 2018, Fonkoué 2019) est solide, la démonstration clinique manque.`,
  ...
  references: [
    { auteurs: `Jaeger P, Zaric D, Fomsgaard JS, et al.`, titre: `Adductor canal block versus femoral nerve block for analgesia after total knee arthroplasty: a randomized, double-blind study`, revue: `Regional Anesthesia and Pain Medicine`, annee: '2013', pmid: '24121608', type: 'ECR', verif: true, note: `Analgésie comparable au bloc fémoral avec préservation de la force du quadriceps.` },
    { auteurs: `Lund J, Jenstrup MT, Jaeger P, Sørensen AM, Dahl JB`, titre: `Continuous adductor-canal-blockade for adjuvant post-operative analgesia after major knee surgery: preliminary results`, revue: `Acta Anaesthesiologica Scandinavica`, annee: '2011', doi: '10.1111/j.1399-6576.2010.02333.x', type: 'série', verif: true },
    { auteurs: `Burckett-St Laurent D, Peng P, Girón Arango L, et al.`, titre: `The nerves of the adductor canal and the innervation of the knee: an anatomic study`, revue: `Regional Anesthesia and Pain Medicine`, annee: '2016', pmid: '27015545', type: 'anatomie', verif: true },
    { auteurs: `Andersen HL, Andersen SL, Tranum-Jensen J`, titre: `The spread of injectate during saphenous nerve block at the adductor canal: a cadaver study`, revue: `Acta Anaesthesiologica Scandinavica`, annee: '2015', doi: '10.1111/aas.12451', type: 'cadavérique', verif: true },
    { auteurs: `Bendtsen TF, Moriggl B, Chan V, Børglum J`, titre: `The optimal analgesic block for total knee arthroplasty`, revue: `Regional Anesthesia and Pain Medicine`, annee: '2016', pmid: '27685346', type: 'revue', verif: true },
    { auteurs: `Trescot AM, Brown MN, Karl HW`, titre: `Infrapatellar saphenous neuralgia — diagnosis and treatment`, revue: `Pain Physician`, annee: '2013', url: 'https://www.semanticscholar.org/paper/Infrapatellar-saphenous-neuralgia-diagnosis-and-Trescot-Brown/f6ada42f5b34d60cbd9cc825843a8dc63d229fd8', type: 'revue', verif: true },
    { auteurs: `Le Corroller T, Lagier A, Pirro N, Champsaur P`, titre: `Anatomical study of the infrapatellar branch of the saphenous nerve using ultrasonography`, revue: `Muscle & Nerve`, annee: '2011', doi: '10.1002/mus.22004', type: 'anatomie', verif: true, note: `Validation de la visualisation échographique de l'IPBSN.` },
    { auteurs: `Mochida H, Kikuchi S`, titre: `Injury to infrapatellar branch of saphenous nerve in arthroscopic knee surgery`, revue: `Clinical Orthopaedics and Related Research`, annee: '1995', pmid: '7586847', type: 'série', verif: true },
    { auteurs: `Kartus J, Movin T, Karlsson J`, titre: `Donor-site morbidity and anterior knee problems after anterior cruciate ligament reconstruction using autografts`, revue: `Arthroscopy`, annee: '2001', pmid: '11694930', type: 'revue', verif: true },
    { auteurs: `Kachar SM, Williams KM, Finn HA`, titre: `Neuroma of the infrapatellar branch of the saphenous nerve: a cause of reversible knee stiffness after total knee arthroplasty`, revue: `The Journal of Arthroplasty`, annee: '2008', url: 'https://www.arthroplastyjournal.org/article/S0883-5403(07)00449-4/abstract', type: 'cas clinique', verif: true },
    { auteurs: `Clendenen S, Greengrass R, Whalen J, O'Connor MI`, titre: `Infrapatellar saphenous neuralgia after TKA can be improved with ultrasound-guided local treatments`, revue: `Clinical Orthopaedics and Related Research`, annee: '2015', doi: '10.1007/s11999-014-3812-6', type: 'série', verif: true },
    { auteurs: `Wu YT, Ho TY, Chou YC, et al.`, titre: `Six-month efficacy of perineural dextrose for carpal tunnel syndrome: a prospective, randomized, double-blind, controlled trial`, revue: `Mayo Clinic Proceedings`, annee: '2017', url: 'https://www.mayoclinicproceedings.org/article/S0025-6196(17)30406-8/abstract', type: 'ECR', verif: true, note: `Base de preuve du dextrose 5 % péri-nerveux — indication différente.` },
    { auteurs: `Cass SP`, titre: `Ultrasound-guided nerve hydrodissection: what is it? A review of the literature`, revue: `Current Sports Medicine Reports`, annee: '2016', doi: '10.1249/JSR.0000000000000226', type: 'revue', verif: true },
