...
- **Trous de la littérature, à assumer** : pas d\'essai de bonne qualité comparant les corticoïdes entre eux ni les doses ; pas de donnée solide sur l\'intérêt propre de l\'orthèse **après** l\'infiltration (l\'usage est bien établi, la preuve l\'est moins) ; pas de comparaison directe infiltration échoguidée contre chirurgie.`,
    ...
    references: [
      { auteurs: 'Richie CA 3rd, Briner WW Jr', titre: 'Corticosteroid injection for treatment of de Quervain\'s tenosynovitis: a pooled quantitative literature evaluation', revue: 'J Am Board Fam Pract', annee: '2003', pmid: '12665175', type: 'revue quantitative', verif: true, note: 'Référence classique du taux de succès de l\'infiltration.' },
      { auteurs: 'Peters-Veluthamaningal C, van der Windt DAWM, Winters JC, Meyboom-de Jong B', titre: 'Corticosteroid injection for de Quervain\'s tenosynovitis', revue: 'Cochrane Database Syst Rev', annee: '2009', doi: '10.1002/14651858.CD005616.pub2', pmid: '19588376', type: 'revue systématique', verif: true },
      { auteurs: 'McDermott JD, Ilyas AM, Nazarian LN, Leinberry CF', titre: 'Ultrasound-guided injections for de Quervain\'s tenosynovitis', revue: 'Clin Orthop Relat Res', annee: '2012', doi: '10.1007/s11999-012-2369-5', pmid: '22552767', type: 'série prospective', verif: true, note: 'Résultats de l\'infiltration échoguidée (40 patients, 42 poignets).' },
      { auteurs: 'Kume K, Amano K, Yamada S, et al.', titre: 'In de Quervain\'s with a separate EPB compartment, ultrasound-guided steroid injection is more effective than a clinical injection technique: a prospective open-label study', revue: 'J Hand Surg Eur Vol', annee: '2012', pmid: '22095403', type: 'étude comparative', verif: true, note: 'Argument central en faveur du guidage en présence d\'un septum.' },
      { auteurs: 'Choi SJ, Ahn JH, Lee YJ, et al.', titre: 'de Quervain disease: US identification of anatomic variations in the first extensor compartment with an emphasis on subcompartmentalization', revue: 'Radiology', annee: '2011', doi: '10.1148/radiol.11102458', pmid: '21613443', type: 'diagnostic', verif: true, note: 'Prévalence de la sous-compartimentation.' },
      { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage)', annee: '2007', doi: '10.1007/978-3-540-28163-4', type: 'ouvrage', verif: true, note: 'Sono-anatomie du 1er compartiment, septum, variantes du LAP.' },
