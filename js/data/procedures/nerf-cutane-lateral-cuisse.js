...
- **Histoire naturelle** : une part notable des méralgies régresse spontanément après suppression du facteur causal ; ce fait, souvent oublié, doit tempérer l’attribution de tout succès au geste réalisé. *Proportion exacte à confirmer.*`,
  ...
  references: [
    { auteurs: 'Tagliafico A, Serafini G, Lacelli F, Perrone N, Valsania V, Martinoli C', titre: 'Ultrasound-guided treatment of meralgia paresthetica (lateral femoral cutaneous neuropathy): technical description and results of treatment in 20 consecutive patients', revue: 'Journal of Ultrasound in Medicine', annee: '2011', doi: '10.7863/jum.2011.30.10.1341', type: 'série prospective', verif: true },
    { auteurs: 'Aszmann OC, Dellon ES, Dellon AL', titre: 'Anatomical course of the lateral femoral cutaneous nerve and its susceptibility to compression and injury', revue: 'Plastic and Reconstructive Surgery', annee: '1997', doi: '10.1097/00006534-199709000-00008', type: 'anatomie', verif: true, note: 'Étude cadavérique de référence sur les variantes de passage au ligament inguinal.' },
    { auteurs: 'Ng I, Vaghadia H, Choi PT, Helmy N', titre: 'Ultrasound imaging accurately identifies the lateral femoral cutaneous nerve', revue: 'Anesthesia and Analgesia', annee: '2008', pmid: '18713931', type: 'étude technique', verif: true },
    { auteurs: 'Hurdle MF, Weingarten TN, Crisostomo RA, Psimos C, Smith J', titre: 'Ultrasound-guided blockade of the lateral femoral cutaneous nerve: technical description and review of 10 cases', revue: 'Archives of Physical Medicine and Rehabilitation', annee: '2007', doi: '10.1016/j.apmr.2007.07.013', type: 'série', verif: true },
    { auteurs: 'Fowler IM, Tucker AA, Mendez RJ', titre: 'Treatment of meralgia paresthetica with ultrasound-guided pulsed radiofrequency ablation of the lateral femoral cutaneous nerve', revue: 'Pain Practice', annee: '2012', doi: '10.1111/j.1533-2500.2011.00522.x', type: 'cas / série', verif: true },
    { auteurs: 'Khalil N, Nicotra A, Rakowicz W', titre: 'Treatment for meralgia paraesthetica', revue: 'Cochrane Database of Systematic Reviews', annee: '2012', doi: '10.1002/14651858.CD004159.pub3', type: 'revue systématique', verif: true, note: 'Revue Cochrane (mise à jour 2012) : aucun ECR identifié, données observationnelles seulement pour l’infiltration et la chirurgie.' },
    { auteurs: 'Lam KHS, Hung CY, Chiang YP, et al.', titre: 'Ultrasound-guided nerve hydrodissection for pain management: rationale, methods, current literature, and theoretical mechanisms', revue: 'Journal of Pain Research', annee: '2020', doi: '10.2147/JPR.S247208', type: 'revue', verif: true, note: 'Base méthodologique de l’hydrodissection au dextrose 5 %.' },
