...
- **Trou de la littérature à assumer** : aucun essai n'a comparé de front les stratégies qui nous intéressent en HDJ douleur — infiltration intra-articulaire répétée *vs* bloc/radiofréquence des nerfs géniculés, sur le patient non opérable. Le choix se fait sur le raisonnement, pas sur la preuve.`,
  ...
  references: [
    { auteurs: `McAlindon TE, LaValley MP, Harvey WF, et al.`, titre: `Effect of intra-articular triamcinolone vs saline on knee cartilage volume and pain in patients with knee osteoarthritis: a randomized clinical trial`, revue: `JAMA`, annee: '2017', type: 'ECR', verif: false, note: `L'essai clé sur la répétition des corticoïdes : perte cartilagineuse, pas de gain antalgique à 2 ans.` },
    { auteurs: `Jüni P, Hari R, Rutjes AWS, et al.`, titre: `Intra-articular corticosteroid for knee osteoarthritis`, revue: `Cochrane Database of Systematic Reviews`, annee: '2015', type: 'revue systématique', verif: false },
    { auteurs: `Sibbitt WL Jr, Peisajovich A, Michael AA, et al.`, titre: `Does sonographic needle guidance affect the clinical outcome of intraarticular injections?`, revue: `The Journal of Rheumatology`, annee: '2009', type: 'ECR', verif: false },
    { auteurs: `Berkoff DJ, Miller LE, Block JE`, titre: `Clinical utility of ultrasound guidance for intra-articular knee injections: a review`, revue: `Clinical Interventions in Aging`, annee: '2012', type: 'revue', verif: false },
    { auteurs: `Bannuru RR, Osani MC, Vaysbrot EE, et al.`, titre: `OARSI guidelines for the non-surgical management of knee, hip, and polyarticular osteoarthritis`, revue: `Osteoarthritis and Cartilage`, annee: '2019', type: 'reco', verif: false },
    { auteurs: `Kolasinski SL, Neogi T, Hochberg MC, et al.`, titre: `2019 American College of Rheumatology/Arthritis Foundation guideline for the management of osteoarthritis of the hand, hip, and knee`, revue: `Arthritis & Rheumatology`, annee: '2020', type: 'reco', verif: false, note: `Recommande **contre** l'acide hyaluronique intra-articulaire au genou.` },
    { auteurs: `Bruyère O, Honvo G, Veronese N, et al.`, titre: `An updated algorithm recommendation for the management of knee osteoarthritis from the European Society for Clinical and Economic Aspects of Osteoporosis, Osteoarthritis and Musculoskeletal Diseases (ESCEO)`, revue: `Seminars in Arthritis and Rheumatism`, annee: '2019', type: 'reco', verif: false },
    { auteurs: `Bennell KL, Paterson KL, Metcalf BR, et al.`, titre: `Effect of intra-articular platelet-rich plasma vs placebo injection on pain and medial tibial cartilage volume in patients with knee osteoarthritis: the RESTORE randomized clinical trial`, revue: `JAMA`, annee: '2021', type: 'ECR', verif: false },
    { auteurs: `Dai WL, Zhou AG, Zhang H, Zhang J`, titre: `Efficacy of platelet-rich plasma in the treatment of knee osteoarthritis: a meta-analysis of randomized controlled trials`, revue: `Arthroscopy`, annee: '2017', type: 'méta-analyse', verif: false },
    { auteurs: `Chu CR, Coyle CH, Chu CT, et al.`, titre: `In vivo effects of single intra-articular injection of 0.5% bupivacaine on articular cartilage`, revue: `The Journal of Bone and Joint Surgery (American volume)`, annee: '2010', type: 'expérimental', verif: false },
    { auteurs: `Kompel AJ, Roemer FW, Murakami AM, et al.`, titre: `Intra-articular corticosteroid injections in the hip and knee: perhaps not as safe as we thought?`, revue: `Radiology`, annee: '2019', type: 'série', verif: false },
    { auteurs: `Di Sante L, Paoloni M, Ioppolo F, Dimaggio M, Di Renzo S, Santilli V`, titre: `Ultrasound-guided aspiration and corticosteroid injection of Baker's cysts in knee osteoarthritis: a prospective observational study`, revue: `American Journal of Physical Medicine & Rehabilitation`, annee: '2010', type: 'série prospective', verif: false },
