...
- **Trous de la littérature, à assumer devant le patient** : aucune étude ne compare hydrodissection et chirurgie ; le **nombre optimal de séances n\'est pas défini** (les protocoles publiés vont de 1 à 3) ; la **radiofréquence pulsée du nerf ulnaire au coude ne repose que sur des séries et des cas cliniques**.`,
  ...
  references: [
    { auteurs: 'van Veen KEB, Wesstein M, van Kasteel V, Bartels RHMA, Visser LH', titre: 'Corticosteroid injection in patients with ulnar neuropathy at the elbow: a randomized, double-blind, placebo-controlled trial', revue: 'Muscle & Nerve', annee: '2015', type: 'ECR', verif: false, note: 'Essai contrôlé négatif — argument central contre le corticoïde de routine sur ce site.' },
    { auteurs: 'Wu YT, Ho TY, Chou YC, et al.', titre: 'Six-month efficacy of perineural dextrose for carpal tunnel syndrome: a prospective, randomized, double-blind, controlled trial', revue: 'Mayo Clinic Proceedings', annee: '2017', type: 'ECR', verif: false, note: 'Essai princeps de l\'hydrodissection au D5W (canal carpien) ; source du protocole transposé au tunnel cubital.' },
    { auteurs: 'Caliandro P, La Torre G, Padua R, Giannini F, Padua L', titre: 'Treatment for ulnar neuropathy at the elbow', revue: 'Cochrane Database of Systematic Reviews', annee: '2016', type: 'revue systématique', verif: false, note: 'Année de la dernière mise à jour à confirmer (plusieurs versions successives).' },
    { auteurs: 'Beekman R, Visser LH', titre: 'Sonography in the diagnosis of carpal tunnel syndrome and ulnar neuropathy at the elbow: a critical review', revue: 'Muscle & Nerve', annee: '2003', type: 'revue', verif: false, note: 'Référence historique sur la mesure de surface de section au coude ; année à confirmer.' },
    { auteurs: 'Assmus H, Antoniadis G, Bischoff C, et al.', titre: 'Cubital tunnel syndrome — a review and management guidelines', revue: 'Central European Neurosurgery', annee: '2011', type: 'reco', verif: false, note: 'Recommandations germanophones de prise en charge ; année à confirmer.' },
    { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage)', annee: '2007', type: 'ouvrage', verif: false, note: 'Référence de sono-anatomie du coude (gouttière, rétinaculum, anconé épitrochléen).' },
    { auteurs: 'Özçakar L, Kara M, Chang KV, et al.', titre: 'EURO-MUSCULUS/USPRM basic scanning protocols for the elbow', revue: 'European Journal of Physical and Rehabilitation Medicine', annee: '2015', type: 'protocole', verif: false, note: 'Protocole de balayage standardisé du coude ; année à confirmer.' },
