...
- **Trous de la littérature, à assumer** : pas de consensus sur le **seuil d\'épaisseur de A1** (les valeurs publiées vont d\'environ 0,5 à 0,9 mm) ; pas de donnée robuste sur le calibre optimal de l\'aiguille de libération (18 à 21 G selon les équipes) ; pas d\'essai comparant libération percutanée échoguidée et infiltration en première intention.`,
    ...
    references: [
      { auteurs: 'Peters-Veluthamaningal C, van der Windt DAWM, Winters JC, Meyboom-de Jong B', titre: 'Corticosteroid injection for trigger finger in adults', revue: 'Cochrane Database Syst Rev', annee: '2009', doi: '10.1002/14651858.CD005617.pub2', pmid: '19160256', type: 'revue systématique', verif: true },
      { auteurs: 'Bodor M, Flossman T', titre: 'Ultrasound-guided first annular pulley injection for trigger finger', revue: 'J Ultrasound Med', annee: '2009', doi: '10.7863/jum.2009.28.6.737', pmid: '19470813', type: 'série', verif: true, note: 'Série prospective de 50 doigts : 94 % de résolution à 6 mois, 90 % à 1 an.' },
      { auteurs: 'Lapègue F, André A, et al.', titre: 'US-guided percutaneous release of the trigger finger by using a 21-gauge needle: a prospective study of 60 cases', revue: 'Radiology', annee: '2016', doi: '10.1148/radiol.2016151886', type: 'série prospective', verif: true, note: 'Équipe radiologique toulousaine ; 60 procédures chez 48 patients après validation cadavérique.' },
      { auteurs: 'Fiorini HJ, Tamaoki MJ, Lenza M, et al.', titre: 'Surgery for trigger finger', revue: 'Cochrane Database Syst Rev', annee: '2018', doi: '10.1002/14651858.CD009860.pub2', type: 'revue systématique', verif: true },
      { auteurs: 'Green DP', titre: 'Green\'s Operative Hand Surgery — classification clinique du doigt à ressort (stades I–IV)', revue: 'Churchill Livingstone / Elsevier (ouvrage de référence, 5e éd. 2005 et suivantes)', annee: '2005', url: 'https://orthofixar.com/hand-surgery/green-classification-of-trigger-finger/', type: 'ouvrage', verif: true, note: 'Source de la classification en stades (I pré-ressaut, II ressaut actif, III ressaut passif, IV contracture) utilisée dans cette fiche.' },
      { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage)', annee: '2007', doi: '10.1007/978-3-540-28163-4', type: 'ouvrage', verif: true, note: 'Sono-anatomie des poulies digitales et des pédicules collatéraux.' },
      { auteurs: 'Özçakar L, Kara M, Chang KV, et al.', titre: 'EURO-MUSCULUS/USPRM basic scanning protocols for the wrist and hand', revue: 'Eur J Phys Rehabil Med', annee: '2015', pmid: '26158917', type: 'protocole', verif: true, note: 'Protocole de balayage standardisé du poignet et de la main.' },
