...
- **Trous de la littérature, à assumer** : le **nombre optimal d\'hydrodissections** n\'est pas établi ; la comparaison directe **hydrodissection contre chirurgie** n\'existe pas ; les seuils de surface de section varient d\'une série à l\'autre (9 à 13 mm²) et dépendent de l\'appareil et de l\'opérateur — le ratio est plus reproductible que la valeur absolue.`,
    ...
    references: [
      { auteurs: 'Marshall SC, Tardif G, Ashworth NL', titre: 'Local corticosteroid injection for carpal tunnel syndrome', revue: 'Cochrane Database Syst Rev', annee: '2007', doi: '10.1002/14651858.CD001554.pub2', pmid: '17443508', type: 'revue systématique', verif: true, note: 'Bénéfice à court terme contre placebo ; versions ultérieures (Ashworth 2020, 2023).' },
      { auteurs: 'Atroshi I, Flondell M, Hofer M, Ranstam J', titre: 'Methylprednisolone injections for the carpal tunnel syndrome: a randomized, placebo-controlled trial', revue: 'Ann Intern Med', annee: '2013', doi: '10.7326/0003-4819-159-5-201309030-00004', pmid: '24026316', type: 'ECR', verif: true, note: '80 mg vs 40 mg vs placebo ; réduction du recours à la chirurgie à 1 an.' },
      ...
      { auteurs: 'Wu YT, Ke MJ, Ho TY, Li TY, Shen YP, Chen LC', titre: 'Randomized double-blinded clinical trial of 5 % dextrose versus triamcinolone injection for carpal tunnel syndrome patients', revue: 'Ann Neurol', annee: '2018', doi: '10.1002/ana.25332', type: 'ECR', verif: true, note: 'D5W vs corticoïde : effet plus durable au-delà du 3e mois.' },
      { auteurs: 'Cartwright MS, Hobson-Webb LD, Boon AJ, et al.', titre: 'Evidence-based guideline: neuromuscular ultrasound for the diagnosis of carpal tunnel syndrome', revue: 'Muscle Nerve', annee: '2012', doi: '10.1002/mus.23389', pmid: '22806381', type: 'reco', verif: true, note: 'Recommandation de l\'AANEM ; échographie en complément de l\'électrodiagnostic.' },
      { auteurs: 'Klauser AS, Halpern EJ, De Zordo T, et al.', titre: 'Carpal tunnel syndrome assessment with US: value of additional cross-sectional area measurements of the median nerve in patients versus healthy volunteers', revue: 'Radiology', annee: '2009', doi: '10.1148/radiol.2501080397', pmid: '19037017', type: 'diagnostic', verif: true, note: 'Origine du delta / ratio poignet-avant-bras.' },
      { auteurs: 'Padua L, Coraci D, Erra C, et al.', titre: 'Carpal tunnel syndrome: clinical features, diagnosis, and management', revue: 'Lancet Neurol', annee: '2016', doi: '10.1016/S1474-4422(16)30231-9', pmid: '27751557', type: 'revue', verif: true, note: 'Revue générale de référence.' },
      { auteurs: 'American Academy of Orthopaedic Surgeons', titre: 'Management of carpal tunnel syndrome — evidence-based clinical practice guideline', revue: 'AAOS / J Am Acad Orthop Surg', annee: '2016', pmid: '27869627', type: 'reco', verif: true, note: 'Version 2016 ; mise à jour AAOS 2024 disponible.' },
      { auteurs: 'Bianchi S, Martinoli C', titre: 'Ultrasound of the Musculoskeletal System', revue: 'Springer (ouvrage)', annee: '2007', doi: '10.1007/978-3-540-28163-4', type: 'ouvrage', verif: true, note: 'Sono-anatomie du poignet, variantes (nerf bifide, artère médiane persistante).' },
