...
Ne pas mélanger deux corticoïdes, ne pas dépasser une dose cumulée annuelle raisonnable chez un patient déjà infiltré ailleurs (rachis, épaule), et privilégier chez le sujet mince ou à peau foncée un **corticoïde non particulaire à faible dose**, voire l\'abstention.`,
  ...
  variantes: [
    ...
    { titre: 'Neurostimulation périphérique et décompression chirurgicale', texte: `En cas de réponse franche mais éphémère aux blocs répétés, chez un patient invalidé : **stimulation périphérique** du nerf clunéal supérieur (série combinant repérage échographique et fluoroscopique) ou **décompression chirurgicale** du tunnel ostéo-fibreux, objet de revues systématiques de séries japonaises (*effectifs à confirmer*). Ces options relèvent d\'un adressage, pas de l\'HDJ — mais c\'est notre bloc test qui les rend défendables.` },
...
- **3 mois** : c\'est le point de mesure des séries publiées (taux de répondeurs de l\'ordre de 78 % à ≥ 3 mois et 83 % à ≥ 6 mois — mais sur des études observationnelles, sans bras contrôle, et sur des patients déjà sélectionnés par un bloc positif).
...
- **Synthèse thérapeutique** : une méta-analyse d\'études **observationnelles** publiée en 2026 rapporte des taux de répondeurs poolés de l\'ordre de **78 % à ≥ 3 mois** et **83 % à ≥ 6 mois**, tous traitements confondus (décompression chirurgicale, infiltrations, radiofréquence, neurostimulation), sur des populations sélectionnées et sans comparaison entre stratégies. *Cette référence n\'a pas pu être revérifiée : elle a été retirée de la bibliographie et ces chiffres sont à traiter comme un ordre de grandeur, non comme une donnée sourcée.* En tout état de cause, ce ne sont pas des chiffres d\'efficacité : sans bras contrôle, ils mesurent surtout la qualité de la sélection par le bloc test.
- **Gestes destructeurs** : radiofréquence du clunéal supérieur décrite dans des **séries de quelques patients** (soulagement rapporté de l\'ordre de 50–90 % à 2–10 semaines, *effectifs et durées à confirmer*) et dans une approche « anatomie-guidée » publiée en 2022 ; cryoneurolyse documentée par des webinaires et des cas. **Preuve très faible** — à réserver aux répondeurs au bloc test, avec information explicite.
- **Trous de la littérature, à assumer** : aucun ECR contre placebo du bloc clunéal ; aucune donnée comparative bloc seul vs bloc + corticoïde ; aucune donnée de durée d\'effet à 12 mois ; le volume optimal et le nombre de sites ne sont pas standardisés ; l\'imagerie du nerf lui-même reste débattue (échanges publiés en 2026 sur la fiabilité de la visualisation échographique du nerf clunéal supérieur). Le geste se justifie par sa **valeur diagnostique**, son innocuité et son coût, plus que par un niveau de preuve d\'efficacité.`,
  ...
  references: [
    ...
    { verif: false, auteurs: '—', titre: 'Superior cluneal nerve radiofrequency ablation for chronic low back and buttock pain: a technical description and case series of three patients', revue: 'Orthopedic Reviews', annee: '2026', type: 'série de cas', note: 'n = 3 ; 65–90 % de soulagement à 2–4 semaines. Référence non revérifiée : à confirmer avant de la citer.' },
  ...
  scenes: [
    {
      ...
      build: S => {
        ...
        S.nerve({ x: 214, y: 198, r: 5, label: 'Br. médiale\n(≈ 6–7 cm de la ligne médiane)', lx: 214, ly: 300, anchor: 'middle', lead: [214, 204], small: true });
        S.nerve({ x: 352, y: 195, r: 4.5, label: 'Br. intermédiaire', lx: 400, ly: 128, anchor: 'start', lead: [356, 190], small: true });
        S.nerve({ x: 476, y: 198, r: 4, label: 'Br. latérale', lx: 560, ly: 300, anchor: 'middle', lead: [482, 203], small: true });
    ...
    },
    {
      ...
      build: S => {
        ...
        S.nerve({ x: 214, y: 198, r: 5 });
        S.nerve({ x: 352, y: 195, r: 4.5 });
        S.nerve({ x: 476, y: 198, r: 4 });
        S.target({ x: 316, y: 198, r: 14 });
        S.needle({ from: [636, 106], to: [318, 200], label: '25 G 40–50 mm, angle 10–20°' });
        S.spread({ x: 300, y: 181, rx: 130, ry: 8, label: '3–5 mL sous le fascia' });
        S.label({ x: 20, y: 116, text: 'Nappe sous-fasciale continue\nsur 3–4 cm = critère de fin', anchor: 'start', cls: 'lbl-target', small: true });
      },
    },
    {
      ...
      build: S => {
        ...
        S.nerve({ x: 296, y: 272, r: 5, label: 'NCM sous le ligament', lx: 296, ly: 330, anchor: 'middle', lead: [296, 278], small: true });
        S.nerve({ x: 396, y: 226, r: 4, label: 'Branche perforante', lx: 470, ly: 300, anchor: 'middle', lead: [400, 231], small: true });
        S.needle({ from: [638, 122], to: [304, 242], label: '25 G, in-plane latéro-médial' });
        S.spread({ x: 250, y: 212, rx: 48, ry: 8, label: '2 mL au-dessus' });
        S.spread({ x: 296, y: 252, rx: 70, ry: 9, label: '2 mL sous le LPSL' });
      },
    },
  ],
