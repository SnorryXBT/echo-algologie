...
- **Trous de la littérature** : peu de données comparatives sur la **ténotomie percutanée** à ce site (extrapolation depuis l’épicondylalgie et la coiffe) ; pas de consensus sur le nombre maximal d’infiltrations ; place de la chirurgie de réinsertion mal codifiée. *À confirmer lors de la passe de vérification bibliographique.*`,
  ...
  references: [
    { auteurs: 'Mellor R, Bennell K, Grimaldi A, et al.', titre: 'Education plus exercise versus corticosteroid injection use versus a wait and see approach on global outcome and pain from gluteal tendinopathy: prospective, single blinded, randomised clinical trial (LEAP)', revue: 'BMJ', annee: '2018', url: 'https://ora.ox.ac.uk/objects/uuid:925d2d75-0078-476b-a792-1b07dcf8e7d7', type: 'ECR', verif: true, note: 'Essai structurant : l’exercice bat l’infiltration à 8 et 52 semaines.' },
    { auteurs: 'Fitzpatrick J, Bulsara MK, O’Donnell J, McCrory PR, Zheng MH', titre: 'The effectiveness of platelet-rich plasma injections in gluteal tendinopathy: a randomized, double-blind controlled trial comparing a single platelet-rich plasma injection with a single corticosteroid injection', revue: 'American Journal of Sports Medicine', annee: '2018', doi: '10.1177/0363546517745525', type: 'ECR', verif: true },
    { auteurs: 'Rompe JD, Segal NA, Cacchio A, Furia JP, Morral A, Maffulli N', titre: 'Home training, local corticosteroid injection, or radial shock wave therapy for greater trochanter pain syndrome', revue: 'American Journal of Sports Medicine', annee: '2009', doi: '10.1177/0363546509334374', type: 'ECR', verif: true },
    { auteurs: 'Pfirrmann CWA, Chung CB, Theumann NH, Trudell DJ, Resnick D', titre: 'Greater trochanter of the hip: attachment of the abductor mechanism and a complex of three bursae — MR imaging and MR bursography in cadavers and MR imaging in asymptomatic volunteers', revue: 'Radiology', annee: '2001', doi: '10.1148/radiol.2211001634', type: 'anatomie', verif: true },
    { auteurs: 'Grimaldi A, Fearon A', titre: 'Gluteal tendinopathy: integrating pathomechanics and clinical features in its management', revue: 'Journal of Orthopaedic and Sports Physical Therapy', annee: '2015', doi: '10.2519/jospt.2015.5829', type: 'revue', verif: true, note: 'Modèle compression-en-adduction, base des consignes posturales données au patient.' },
    { auteurs: 'Long SS, Surrey DE, Nazarian LN', titre: 'Sonography of greater trochanteric pain syndrome and the rarity of primary bursitis', revue: 'American Journal of Roentgenology', annee: '2013', doi: '10.2214/AJR.12.10038', type: 'série', verif: true, note: 'Série échographique (877 patients) : bursite présente dans 20 % des cas seulement.' },
    { auteurs: 'Brinks A, van Rijn RM, Willemsen SP, et al.', titre: 'Corticosteroid injections for greater trochanteric pain syndrome: a randomized controlled trial in primary care', revue: 'Annals of Family Medicine', annee: '2011', pmid: '21555750', type: 'ECR', verif: true, note: 'Bénéfice à 3 mois, disparu à 12 mois.' },
