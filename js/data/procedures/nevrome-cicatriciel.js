...
- Si la peau cicatricielle est irrégulière, gel en excès ou coussin de gel pour obtenir un contact acoustique correct.`,
  ...
  technique: [
    ...
    { titre: 'Infiltration de corticoïde — quand la composante inflammatoire domine', texte: 'À réserver aux cicatrices récentes et inflammatoires, ou aux échecs partiels de l\'hydrodissection. **Dexaméthasone 4 mg (non particulaire)** ajoutée au volume d\'hydrodissection et déposée en péri-neural. La méthylprednisolone 20–40 mg est une suspension **particulaire** : elle ne se discute que sur une cicatrice sans artère dans le champ, et jamais au contact immédiat du nerf. Pas de répétition rapprochée sur une cicatrice : le sous-cutané se fragilise et se dépigmente.' },
...
| Composante inflammatoire | **Dexaméthasone 4 mg (non particulaire)**, ajoutée au volume d'hydrodissection. Méthylprednisolone 20–40 mg (particulaire) seulement sur une cicatrice sans artère dans le champ | 3–10 mL au total | Non particulaire par principe sur ces sites superficiels et vascularisés. Pas de répétition rapprochée |
